  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-12 text-ink prose-relaxed">
      ...
      <p className="mb-6 text-ink-muted">
        <strong className="text-ink">Nível:</strong> Iniciante
      </p>
...
<html>
  ...
  <body>
    ...
    <p>Esta é minha primeira página HTML.</p>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2 text-ink">🔍 Explicação:</h3>
        <ul className="list-disc list-inside space-y-1 text-ink">
          <li><code className="text-brand">&lt;!DOCTYPE html&gt;</code> → Informa ao navegador que é um documento HTML5.</li>
          <li><code className="text-brand">&lt;html&gt;</code> → A raiz do documento.</li>
          <li><code className="text-brand">&lt;head&gt;</code> → Configurações invisíveis da página.</li>
          <li><code className="text-brand">&lt;title&gt;</code> → Nome que aparece na aba do navegador.</li>
          <li><code className="text-brand">&lt;body&gt;</code> → Onde colocamos o conteúdo visível.</li>
          <li><code className="text-brand">&lt;h1&gt;</code> → Título principal.</li>
          <li><code className="text-brand">&lt;p&gt;</code> → Parágrafo de texto.</li>
        </ul>
      </section>
        ...
        <div className="overflow-x-auto rounded-xl border border-surface-subtle">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-surface-subtle">
              <tr>
                <td className="p-2">&lt;h1&gt; ... &lt;h6&gt;</td>
                <td className="p-2">Títulos</td>
                <td className="p-2">&lt;h1&gt;Grande&lt;/h1&gt;</td>
              </tr>
              <tr>
                <td className="p-2">&lt;p&gt;</td>
                <td className="p-2">Parágrafo</td>
                <td className="p-2">&lt;p&gt;Olá!&lt;/p&gt;</td>
              </tr>
              <tr>
                <td className="p-2">&lt;a&gt;</td>
                <td className="p-2">Link</td>
                <td className="p-2">&lt;a href="https://google.com"&gt;Google&lt;/a&gt;</td>
              </tr>
              <tr>
                <td className="p-2">&lt;img&gt;</td>
                <td className="p-2">Imagem</td>
                <td className="p-2">&lt;img src="foto.jpg" alt="Minha foto"&gt;</td>
              </tr>
            </tbody>
          </table>
        </div>
    ...
    <a href="https://www.google.com" target="_blank">Visite o Google</a>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-ink">
          <li>Crie um arquivo <code className="text-brand">index.html</code>.</li>
