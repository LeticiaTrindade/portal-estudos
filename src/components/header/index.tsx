...
export default function Header() {
  ...
  return (
    <header className="bg-surface/80 dark:bg-surface-darkAlt/80 backdrop-blur supports-[backdrop-filter]:bg-surface/70 border-b border-surface-subtle  dark:border-surface-dark sticky top-0 z-40">
